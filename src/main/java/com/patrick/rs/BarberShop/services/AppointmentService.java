...
//import com.patrick.rs.BarberShop.models.Appointment;
...
//
//    /**
//     * Finds all appointments by a User, in the DB, and returns it or null if none found.
//     *
//     * @param userId the id of the user
//     * @return Appointment | null
//     */
//    public Appointment findByUserId(long userId) {
//        return appointmentRepo.findAllByUserId(userId).orElse(null);
//    }
//
//
//    /**
//     * Attempts to save an appointment to the DB. Throws an exception if the email or phone number are already registered.
//     *
